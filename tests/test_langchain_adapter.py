...
class TestLegacyFunctions:
    ...
    @pytest.mark.asyncio
    async def test_legacy_to_data_stream(self, mock_async_stream):
        """Test legacy to_data_stream function."""
        from langchain_aisdk_adapter.langchain_adapter import to_data_stream
    ...
    def test_legacy_to_data_stream_response(self, mock_async_stream):
        """Test legacy to_data_stream_response function."""
        from langchain_aisdk_adapter.langchain_adapter import to_data_stream_response
        ...
        with patch('fastapi.responses.StreamingResponse') as mock_response:
            ...
            result = to_data_stream_response(
                stream=mock_async_stream(stream_items)
            )
    ...
    @pytest.mark.asyncio
    async def test_legacy_merge_into_data_stream(self, mock_async_stream):
        """Test legacy merge_into_data_stream function."""
        from langchain_aisdk_adapter.langchain_adapter import merge_into_data_stream
